...
echo "🛑 Stopping Media Management Service containers..."
print_separator "="
...
kubectl scale deployment media-management-service --replicas=0 -n "$NAMESPACE"
...
print_separator "="
print_status "ok" "Media Management Service containers stopped"
